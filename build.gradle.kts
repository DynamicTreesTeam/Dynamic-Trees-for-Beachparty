...
dependencies {
    ...
    runtimeOnly(fg.deobf("curse.maven:dynamic-trees-addon-lib-1404692:7377860"))
    ...
    //Other
    runtimeOnly(fg.deobf("curse.maven:lets-do-beachparty-858691:6849930"))
